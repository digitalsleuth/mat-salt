...
# header-parser.py
#
# Parse headers of Salt state files,
# generate a listing of the tools described by the files,
# and place the output in the designated space on Gitbook.
#
# Originally designed for use for REMnux salt-states.
# Modified for usage with MAT salt-states.
# Created by:
#
...
DEFAULT_REPO_URL = "https://github.com/digitalsleuth/mat-salt"
